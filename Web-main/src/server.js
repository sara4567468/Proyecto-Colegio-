...
app.post('/verEntregas',authenticateToken,async(req,res)=>{
...
app.post('/eliminarTarea',authenticateToken,async(req,res)=>{
  const tarea_id=req.body.tarea_id
  try{
...
app.post('/crearEntrega',upload.single('archivo_entrega'),authenticateToken,async(req,res)=>{
...
app.post('/isEntregada',authenticateToken,async(req,res)=>{
  const tarea_id=req.body.tarea_id
...
app.post('/entregasProximas',authenticateToken,async(req,res)=>{
  const user_id=req.body.user_id
  const group_id=req.body.group_id
  try{
